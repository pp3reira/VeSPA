...
--               /home/marcelo/Desktop/vsp/vsp.gen/sources_1/bd/Instruction_Mem_IP/ip/Instruction_Mem_IP_Address_Adder_0_1/Instruction_Mem_IP_Address_Adder_0_1_sim_netlist.vhdl
...
entity Instruction_Mem_IP_Address_Adder_0_1_Address_Adder is
  port (
    OUT_0 : out STD_LOGIC_VECTOR ( 9 downto 0 );
    IN_0 : in STD_LOGIC_VECTOR ( 9 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Instruction_Mem_IP_Address_Adder_0_1_Address_Adder : entity is "Address_Adder";
end Instruction_Mem_IP_Address_Adder_0_1_Address_Adder;

architecture STRUCTURE of Instruction_Mem_IP_Address_Adder_0_1_Address_Adder is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Instruction_Mem_IP_Address_Adder_0_1 is
  port (
    IN_0 : in STD_LOGIC_VECTOR ( 9 downto 0 );
    OUT_0 : out STD_LOGIC_VECTOR ( 9 downto 0 )
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of Instruction_Mem_IP_Address_Adder_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Instruction_Mem_IP_Address_Adder_0_1 : entity is "Instruction_Mem_IP_Address_Adder_0_1,Address_Adder,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Instruction_Mem_IP_Address_Adder_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of Instruction_Mem_IP_Address_Adder_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of Instruction_Mem_IP_Address_Adder_0_1 : entity is "Address_Adder,Vivado 2023.2";
end Instruction_Mem_IP_Address_Adder_0_1;

architecture STRUCTURE of Instruction_Mem_IP_Address_Adder_0_1 is
begin
inst: entity work.Instruction_Mem_IP_Address_Adder_0_1_Address_Adder
     port map (

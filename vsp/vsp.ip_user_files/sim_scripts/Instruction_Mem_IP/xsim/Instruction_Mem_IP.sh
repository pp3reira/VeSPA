...
#
# Script generated by Vivado on Sun Dec 10 14:56:35 WET 2023
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Instruction_Mem_IP.sh
...
#
# Usage        : Instruction_Mem_IP.sh
#                Instruction_Mem_IP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Instruction_Mem_IP.sh [-reset_run]
#                Instruction_Mem_IP.sh [-reset_log]
#                Instruction_Mem_IP.sh [-help]
#
...
# script info
echo -e "Instruction_Mem_IP.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Instruction_Mem_IP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Instruction_Mem_IP xil_defaultlib.Instruction_Mem_IP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Instruction_Mem_IP -key {Behavioral:sim_1:Functional:Instruction_Mem_IP} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/RegFile_IP.protoinst" -protoinst "protoinst_files/Instruction_Mem_IP.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Instruction_Mem_IP.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Instruction_Mem_IP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Instruction_Mem_IP.sh [-help]\n\
Usage: Instruction_Mem_IP.sh [-step]\n\
Usage: Instruction_Mem_IP.sh [-lib_map_path]\n\
Usage: Instruction_Mem_IP.sh [-reset_run]\n\
Usage: Instruction_Mem_IP.sh [-reset_log]\n\
Usage: Instruction_Mem_IP.sh [-keep_index]\n\
Usage: Instruction_Mem_IP.sh [-noclean_files]\n\n\

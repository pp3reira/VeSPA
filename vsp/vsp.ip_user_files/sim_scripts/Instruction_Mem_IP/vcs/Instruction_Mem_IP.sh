...
#                script (type 'Instruction_Mem_IP.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Instruction_Mem_IP xil_defaultlib.glbl -o Instruction_Mem_IP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Instruction_Mem_IP_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/marcelo/Desktop/APRESENTACAO_VESPA/Comecar_com_perifericos/vsp/vsp.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key Instruction_Mem_IP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Instruction_Mem_IP_simv.daidir vcs_lib c.obj)

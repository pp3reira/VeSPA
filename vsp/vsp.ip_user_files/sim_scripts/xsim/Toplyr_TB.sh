...
#
# Script generated by Vivado on Sun Nov 26 12:29:09 WET 2023
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Toplyr_TB.sh
...
#
# Usage        : Toplyr_TB.sh
#                Toplyr_TB.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Toplyr_TB.sh [-reset_run]
#                Toplyr_TB.sh [-reset_log]
#                Toplyr_TB.sh [-help]
#
...
# script info
echo -e "Toplyr_TB.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Toplyr_TB.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Toplyr_TB xil_defaultlib.Toplyr_TB xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Toplyr_TB -key {Behavioral:sim_1:Functional:Toplyr_TB} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Toplyr_TB.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Toplyr_TB.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Toplyr_TB.sh [-help]\n\
Usage: Toplyr_TB.sh [-step]\n\
Usage: Toplyr_TB.sh [-lib_map_path]\n\
Usage: Toplyr_TB.sh [-reset_run]\n\
Usage: Toplyr_TB.sh [-reset_log]\n\
Usage: Toplyr_TB.sh [-keep_index]\n\
Usage: Toplyr_TB.sh [-noclean_files]\n\n\

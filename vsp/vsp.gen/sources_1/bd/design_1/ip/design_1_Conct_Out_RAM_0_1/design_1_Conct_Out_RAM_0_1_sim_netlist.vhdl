...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_Conct_Out_RAM_0_1 -prefix
--               design_1_Conct_Out_RAM_0_1_ Instruction_Mem_IP_Conct_Out_RAM_0_0_sim_netlist.vhdl
...
entity design_1_Conct_Out_RAM_0_1 is
  port (
    clk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_Conct_Out_RAM_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_Conct_Out_RAM_0_1 : entity is "Instruction_Mem_IP_Conct_Out_RAM_0_0,Conct_Out_RAM,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_Conct_Out_RAM_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_Conct_Out_RAM_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_Conct_Out_RAM_0_1 : entity is "Conct_Out_RAM,Vivado 2023.2";
end design_1_Conct_Out_RAM_0_1;

architecture STRUCTURE of design_1_Conct_Out_RAM_0_1 is
